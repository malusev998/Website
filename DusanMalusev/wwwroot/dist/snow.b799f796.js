...
})({"dYObH":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = 1234;
...
async function loadPolygonMaskPlugin(tsParticles) {
    if (!Utils_1.isSsr()) {
        if (!window.SVGPathSeg) await Promise.resolve().then(function() {
            return require("c86a912776aba12c");
...
},{"./PolygonMaskInstance":"2DkLC","./Options/Classes/PolygonMask":"jTB48","./Enums":"790YU","../../Utils":"jlrec","c86a912776aba12c":"4jB3m"}],"2DkLC":[function(require,module,exports) {
"use strict";
Object.defineProperty(exports, "__esModule", {
    value: true
});
